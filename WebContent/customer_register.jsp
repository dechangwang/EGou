	...
	<div id="top_link">
		...
		<div id="container">
			...
			<div id="gogou-outer">
				...
				<div id="gogou">
			<form id="myForm" action="CustomerRegisterServlet" method="post" onsubmit="return submitTo()"> 
			<input type="hidden" name="method" value="guestReg">
						...
						<div id='username' class='outerDiv'>
							...
							<input type="password" name="customerPwd" id="userpw"  required  /> 
						...
						<div id='email' class='outerDiv'>
							...
							<input type="number" name="cPhone" required /> 
