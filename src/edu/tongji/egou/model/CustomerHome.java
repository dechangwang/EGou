...
// Generated 2015-5-30 16:34:32 by Hibernate Tools 4.0.0
 ...
 * @see edu.tongji.egou.model.Customer
	...
	public Customer findById(java.lang.String id) {
		...
		try {
			Customer instance = (Customer) sessionFactory.getCurrentSession()
					.get("edu.tongji.egou.model.Customer", id);
			if (instance == null) {
	...
	public List findByExample(Customer instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("edu.tongji.egou.model.Customer")
